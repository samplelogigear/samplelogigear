...
$name = $email = $gender = $comment = $website = $company = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $company = (test_input(isset($_POST["company"])) ? $_POST["company"] : null);
}
...
<br><br>
Company : <input type="text" id="txtSample" name="company" form="form1">
